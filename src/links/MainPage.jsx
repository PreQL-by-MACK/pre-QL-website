  ...
  return(
    ...
    <footer className="p-5 bg-dark text-white text-center position-relative">
      <div className="container">
        ...
        <p className="lead"><a href="https://github.com/oslabs-beta/preql">{github}</a><a href="https://linkedin.com/company/preql/">{linkedIn}</a><i className="bi bi-github text-light mx-1" style={{fontSize:"36px"}}></i></p>
